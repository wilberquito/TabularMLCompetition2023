...
param_grid = {'n_estimators': np.arange(250, 1501, 250),
              'max_depth': [13, 14],
...
g_01 = grid_search_runner(clf, X_train, y_train, X_test,
                          y_test, param_grid, verbose=10)
...
param_grid = {'model__n_estimators': np.arange(250, 1501, 250),
